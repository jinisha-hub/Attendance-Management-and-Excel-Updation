...
SECRET_KEY = 'django-insecure-i^7)4(!rds*@w1q15ujo$gynkn=q9ny^0hx&%)1q6cdm9mo=%w'
...
DATABASES = {
    'default': {
        'ENGINE': "google.cloud.firestore.django.backends.firestore",
